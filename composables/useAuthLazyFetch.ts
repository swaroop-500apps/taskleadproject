...
export const useAuthLazyFetch = (request: any, options: any | undefined | null) => {
    ...
    return useLazyFetch(request, {
        ...
        onRequest({ request, options }) {
            ...
            options.headers = {
                Authorization: `Bearer ${'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1IjoiM2FiNGRhMmU2ZmZlNDFhMThkMjBhY2U5NDM1MjI5MmYiLCJkIjoiMTY4MDA5MSIsInIiOiJzYSIsInAiOiJmcmVlIiwiYSI6ImZpbmRlci5pbyIsImwiOiJ1czEiLCJleHAiOjE2ODMyODMxOTN9.Syb1XQeqr9lBLaIeS2TCyl760cmliwBooz9oRcrGCjo'}`,
            }   
        },
